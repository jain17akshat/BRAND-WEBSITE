...
export const ProductImage = ({ src, hoverSrc, images, alt, artType = 'brass', className = '', aspect = 'aspect-square', fitMode, priority = false }) => {
        ...
        {imageList.map((imgSrc, idx) => {
          ...
          return (
            <img
              ...
              loading={priority || idx === 0 ? (priority ? 'eager' : 'lazy') : 'lazy'}
              decoding="async"
